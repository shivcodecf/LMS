...
const Profile = () => {
  ...
  const [
    updateUser,
    { data: updateUserData, isLoading: updateLoading, isError, error, isSuccess },
  ...
  const totalCourses = Array.isArray(user.enrolledCourses) ? user.enrolledCourses.length : 0;
    ...
    <div className="max-w-6xl mx-auto px-6 py-10">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Manage your account details and enrolled courses.</p>
        </div>
  ...
  >
    ...
    <div className="flex items-start justify-between">
      <div>
        ...
        <p className="text-sm text-gray-500">Change your display name and profile photo.</p>
      </div>
    ...
    <div className="mt-5 space-y-6">
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="mt-2 text-xs text-gray-500">Click the camera icon to change your photo</p>
      </div>
...
{/* ------------------ end dialog ------------------ */}
      ...
      <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-2xl shadow-sm p-6">
        <div className="grid grid-cols-1 md:grid-cols-[160px_1fr] gap-6 items-start">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="mt-3 text-sm text-gray-500">Member since {new Date(user.createdAt).toLocaleDateString()}</p>
          </div>
          ...
          <div className="min-w-0">
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0">
                <h2 className="text-2xl font-semibold leading-tight truncate">{user.name}</h2>
                ...
                <div className="mt-4 flex flex-wrap items-center gap-3">
                  ...
                  <div className="h-8 flex items-center px-3 rounded-full bg-white border border-gray-200">
                    ...
                    <span className="ml-2 text-sm font-semibold">{totalCourses}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="shrink-0 hidden md:flex flex-col items-end">
                <Button onClick={() => setIsEditOpen(true)}>Edit Profile</Button>
                <Button variant="ghost" className="mt-2">View Activity</Button>
              </div>
            </div>
      ...
      {/* Enrolled courses */}
      <div className="mt-10">
        <h3 className="text-xl font-semibold mb-4">Courses You're Enrolled In</h3>
        ...
        {totalCourses === 0 ? (
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-800 p-8 text-center shadow-sm">
            ...
            <div className="flex justify-center">
              <Link to={`/course/search?query`}><Button>Browse Courses</Button></Link>
            </div>
          </div>
        ) : (
